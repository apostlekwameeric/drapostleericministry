...
CREATE TABLE IF NOT EXISTS brand (
  ...
  home_banner_mime text,
  home_banner_data bytea,
  home_banner_version integer NOT NULL DEFAULT 0,
...
ALTER TABLE brand ADD COLUMN IF NOT EXISTS home_banner_mime text;
ALTER TABLE brand ADD COLUMN IF NOT EXISTS home_banner_data bytea;
ALTER TABLE brand ADD COLUMN IF NOT EXISTS home_banner_version integer NOT NULL DEFAULT 0;
